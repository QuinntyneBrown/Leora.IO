...
namespace Leora.Commands.CQRS
{
    ...
    public class GenerateQueryCommand : Leora.Commands.CQRS.Core.BaseCommand<GenerateQueryOptions>, IGenerateQueryCommand
    {
        ...
        public int Run(string entityName, string namespacename, string directory, string name, string rootNamespace)
        {
            ...
            var templateCs = _templateManager.Get(FileType.CSharp, "CQRSQuery", "Queries", _namingConventionConverter.Convert(NamingConvention.PascalCase, name), BluePrintType.CQRS);
