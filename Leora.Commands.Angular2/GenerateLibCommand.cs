...
{
    public class GenerateLibCommand : BaseCommand<GenerateLibOptions>, IGenerateLibCommand
    {
        ...
        public override int Run(GenerateLibOptions options) => Run(options.Name, options.ComponentName, options.Directory);
        ...
        public int Run(string name, string entity, string directory)
        {
            ...
            var projectNameSnakeCase = _namingConventionConverter.Convert(NamingConvention.SnakeCase, name);
            var projectDirectory = $"{directory}\\{projectNameSnakeCase}\\";
            CreateDirectory($"{projectDirectory}");
            CreateDirectory($"{projectDirectory}\\src");
            CreateDirectory($"{projectDirectory}\\src\\demo-app");
            CreateDirectory($"{projectDirectory}\\src\\lib");
            CreateDirectory($"{projectDirectory}\\src\\lib");
            _generateTypingsCommand.Run(name, projectDirectory);
